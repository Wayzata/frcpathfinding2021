...
public class AutoDriveSystem {
    ...
    public MecanumDriveWheelSpeeds getSpeeds() { // NEED TO VALIDATE Auto.kEncoderTicksPerRev AND EQUATION
        return new MecanumDriveWheelSpeeds(
            (frontLeft.getSelectedSensorVelocity() * 10)*(Units.inchesToMeters(Auto.kWheelRadiusInches) / Auto.kEncoderTicksPerRev),
            (frontRight.getSelectedSensorVelocity() * 10)*(Units.inchesToMeters(Auto.kWheelRadiusInches) / Auto.kEncoderTicksPerRev),
            (backLeft.getSelectedSensorVelocity() * 10)*(Units.inchesToMeters(Auto.kWheelRadiusInches) / 1440.0), // Different Encoder. 1440 per rev
            (backRight.getSelectedSensorVelocity() * 10)*(Units.inchesToMeters(Auto.kWheelRadiusInches) / Auto.kEncoderTicksPerRev)
        );
    }
